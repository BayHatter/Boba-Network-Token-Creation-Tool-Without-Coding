# Boba Network Token Creation Tool

A simple frontend tool to create tokens on the Boba Network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Boba-Network-Token-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Boba Network Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Boba-Network-Token-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Boba Network wallet address for receiving fees. Also set fee in ETH that you want to charge
